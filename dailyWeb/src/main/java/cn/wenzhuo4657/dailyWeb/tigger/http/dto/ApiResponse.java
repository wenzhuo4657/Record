...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> success() {
        return new ApiResponse<>(ResponseCode.SUCCESS.getCode(), ResponseCode.SUCCESS.getInfo());
    }
    ...
    public static <T> ApiResponse<T> error() {
        return new ApiResponse<>(ResponseCode.FAILED.getCode(), ResponseCode.FAILED.getInfo());
    }
